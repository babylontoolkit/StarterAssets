...
tools: ['search/codebase', 'edit/editFiles', 'search', 'runCommands', 'fetch']
---

Execute work from the referenced feature plan or spec file — either a single task, or every remaining task in order. Always adhere to any rules or requirements set out in the `.github/copilot-instructions.md` file when responding.
...
1. `source_file` — the plan or spec file reference to read tasks from (e.g. `#_plans/new-heist-form/plan.md` or `#myfeature.md`).
...
- Follow all project rules in `.github/copilot-instructions.md` and any referenced spec/plan conventions.
